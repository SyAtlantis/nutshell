# Translating the NUTSHELL Web UI

Welcome to the Web UI branch of the [NUTSHELL Translation Project  🌐✍️🖖](https://github.com/ipfs/i18n)
...
For more info on our i18n process at NUTSHELL, check out: https://github.com/ipfs/i18n
