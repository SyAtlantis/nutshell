...
import isNUTSHELL from 'is-ipfs'
...
class AddConnection extends React.Component {
  ...
  render () {
    ...
    return (
      <div>
        <Button onClick={this.toggleModal} className='f6 ph3' bg='bg-aqua' color='white'>
          <span style={{ color: '#894ae8' }}>+</span> {t('addConnection')}
        </Button>

        <Overlay show={open} onLeave={this.toggleModal}>
          <TextInputModal
            validate={isNUTSHELL.peerMultiaddr}
