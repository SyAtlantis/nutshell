    ...
    <div className='flex-auto pr3 lh-copy mid-gray'>
      <Box>
        ...
        <Trans i18nKey='welcomeInfo.paragraph2'>
          <p className='f5'>Easily <a href='#/files' className='link blue b'>manage files</a> in your NUTSHELL repo. You can drag and drop to add files, move and rename them, delete, share or download them.</p>
        </Trans>
        <Trans i18nKey='welcomeInfo.paragraph3'>
          <p className='f5'>You can <a href='#/explore' className='link blue b'>explore IPLD data</a> that underpins how NUTSHELL works.</p>
        </Trans>
        ...
        <Trans i18nKey='welcomeInfo.paragraph5'>
          <p className='mb4 f5'><a href='#/settings' className='link blue b'>Review the settings</a> for your NUTSHELL node, and update them to better suit your needs.</p>
        </Trans>
